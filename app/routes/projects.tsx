...
},
{
  ...
  "description": "Speak for the Trees Boston aims to improve the size and health of the urban forest in the greater Boston area, with a focus on under-served and under-canopied neighborhoods. They work with volunteers to inventory (collect data on) trees, plant trees, and educate those about trees...",
  "link": "https://en.wikipedia.org/wiki/Sirocco_(parrot)"
},
{
  "image": "https://i.imgur.com/1D8yxOo.gif",
  ...
  "description": "Since its founding in 2011, This Star Won’t Go Out has helped hundreds of families, with gifts totaling over $450,000 to help families suffering from financial hardship related to childhood cancer. We're helping to streamline this system so that TSWGO can focus their attention on helping families.",
  "link": "https://en.wikipedia.org/wiki/Sirocco_(parrot)"
},
{
}
